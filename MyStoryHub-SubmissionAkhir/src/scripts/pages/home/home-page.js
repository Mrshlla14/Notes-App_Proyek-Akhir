...
async afterRender() {
  ...
  const storiesSection = document.getElementById("stories-section"); // Definisikan variabel di sini

  if (visibleSkipButton && storiesSection) { // Pastikan kedua elemen ada
  ...
  // Menambahkan tombol untuk berlangganan notifikasi
  ...
  // Menambahkan tombol notifikasi ke dalam container
  if (storiesSection) {
