...
export async function testPushNotification() {
  try {
    ...
    if (!subscription) {
      alert(
        "Anda belum berlangganan notifikasi. Silakan aktifkan notifikasi terlebih dahulu."
      );
      return false;
    }
...
export function convertBase64ToUint8Array(base64String) {
  try {
    ...
    if (typeof base64String !== "string") {
      console.error(
        "convertBase64ToUint8Array: Input bukan string",
        base64String
      );
    ...
    // Log untuk debugging
    console.log(
      "Converting base64 string to Uint8Array, length:",
      base64String.length
    );
